...
!-------------------------------------------------------------------------
  ...
  lowrleft=1.25*exp(-1.70d2/T*3d0)*2.35d-14*3d0   !Eqn 6.40 (left term) rotational
  lowrright=1.75*exp(-5.05d2/T*1.683)*6.97d-14*1.683  !Eqn 6.40 (right term) rotational
